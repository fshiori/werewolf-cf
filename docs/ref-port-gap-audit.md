...
| Rendered non-JSON pages | `/`, `/list`, `/logs`, `/bbs`, `/admin`, `/admin/bbs`, `/admin/rooms`, `/admin/config`, `/trip`, `/trips`, `/room/:id`, `/leaderboard`, `/stats`, `/icons`, `/status`, `/room/:id/records`, `/room/:id/events`, `/player/:id`, `/rules`, `/manual`, `/script-info`, `/protocol`, `/version`; PHP-style aliases `/index.php`, GET `/room_manager.php`, `/list.php`, `/old_log.php`, `/bbs.php`, `/icon_view.php`, `/icon_upload.php`, `/rule.php`, `/script_info.php`, `/stats.php`, `/trip.php`, `/version.php`, `/admin.php`, `/game_log.php?room_no=:id`, `/game_view.php?room_no=:id`, `/game_play.php?room_no=:id`, `/game_frame.php?room_no=:id`, `/game_up.php?room_no=:id`, GET `/game_vote.php?room_no=:id`, `/login.php?room_no=:id`, `/user_manager.php?room_no=:id` | Implemented |
