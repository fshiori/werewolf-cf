...
- Reference has resident exit/reset vote handling while waiting. Current lobby kick exists, and players can voluntarily leave the lobby resident list with host reassignment; vote-based start/kick reset semantics are not equivalent.
