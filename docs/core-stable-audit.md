...
| Full screenshot parity against the PHP reference | `docs/visual-parity-checklist.md` exists and Playwright Chromium capture now covers static/lobby/frame/day/GM-controls/night/ended and public/player/dead/GM old-log pages with broken-image checks, but manual comparison against the PHP reference remains. |
