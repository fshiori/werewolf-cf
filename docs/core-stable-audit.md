...
| Full screenshot parity against the PHP reference | `docs/visual-parity-checklist.md` exists and Playwright Chromium is now available for capture, but screenshot baseline capture/comparison has not yet been made part of the stable gate. Core HTML smoke covers page availability and legacy entry shapes. |
