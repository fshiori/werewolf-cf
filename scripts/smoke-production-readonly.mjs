...
const checks = [
  ...
  { path: "/logs", kind: "html", expectedText: ["過去紀錄", "村No"] },
  { path: "/trip", kind: "html", expectedText: ["身份登錄", "Trip公開資料"] },
  ...
  { path: "/protocol", kind: "html", expectedText: ["WebSocket 入口", "common_voice", "gameStateFields", "actionAckActions"] },
