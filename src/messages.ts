...
export function buildActionAckMessage(
  action: "vote" | "night_kill" | "divine" | "guard" | "child_fox_divine" | "cat_revive" | "kick_player" | "leave_room" | "gm_set_alive" | "gm_set_role" | "gm_set_flag" | "gm_set_common_voice" | "gm_set_channel_restrictions",
  targetPlayerId: string
): ServerMessage {
