  ...
  return page("Protocol", shell(`
    ...
    <fieldset>
      ...
      <table class="form-table">
        ...
        <tr><td><strong>　game_state：</strong></td><td>房間 <code>roomId</code>、公開階段、日期、玩家生死、<code>openVote</code>/<code>selfVote</code>/<code>voteStatus</code> 投票選項、只回傳給本人的夜晚行動目標、勝者、計時與系統 log。</td></tr>
        ...
        <tr><td><strong>　action_ack：</strong></td><td>確認投票、襲擊、占卜、護衛、子狐占卜、貓又復活、踢人、退出、廢村請求或 GM 換日/裁定/生死/角色/旗標/選項調整。</td></tr>
